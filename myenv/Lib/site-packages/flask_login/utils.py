...
def logout_user():
    ...
    if "_user_id" in session:
        ...
        print("'_user_id' removed from session")

    if "_fresh" in session:
        session.pop("_fresh")
        print("'_fresh' removed from session")

    # Add similar print statements for other session variables
    ...
    if cookie_name in request.cookies:
        ...
        print("Remember me cookie cleared")

    user_logged_out.send(current_app._get_current_object(), user=user)
    print("User logged out event dispatched")

    current_app.login_manager._update_request_context_with_user()
    print("Request context updated with logged out user")
